...
class tjText(models.Model):
    ...
    words_q = models.IntegerField( null=True, blank=True, verbose_name="Общее кол-во слов")
    syllables_avg = models.FloatField( null=True, blank=True, verbose_name="Сөздөрдүн орточо узундугу муундар менен")
    sentence_q = models.IntegerField( null=True, blank=True, verbose_name="Общее кол-во предложений")
    sentence_avg = models.FloatField( null=True, blank=True, verbose_name="Ср. длина слова в слогах")
    multisyllabic_wq = models.FloatField( null=True, blank=True, verbose_name="Кол-во многосложных слов")
    compound_w_q = models.FloatField( null=True, blank=True, verbose_name="Сложные слова и слова с дефисом")
    rareword_q = models.FloatField( null=True, blank=True, verbose_name="Кол-во редких слов для 1-4 классов")
    rareword_p = models.FloatField( null=True, blank=True, verbose_name="% редких слов")
    complex_w_q = models.FloatField(null=True, blank=True,verbose_name='Кол-во составных слов')
    ...
    uniq_w = models.IntegerField( null=True, blank=True, verbose_name="Кол-во уникальных слов")
    ...
    class Meta:
        verbose_name = "Текст на таджикском"
        verbose_name_plural = "Тексты на таджикском"
...
class FreqWord(models.Model):
    ...
    class Meta:
        verbose_name = "Часто используемые слова"
        verbose_name_plural = "Часто используемые слова"

class LCWord(models.Model):
    lc_words = models.TextField(null=True, blank=True,verbose_name='Сложные слова')

    def __str__(self):
        return self.lc_words  
    
    class Meta:
        verbose_name = "Сложные слова"
        verbose_name_plural = "Сложные слова"

class RareWord(models.Model):
    rare_words = models.TextField(null=True, blank=True,verbose_name='Редкие слова')

    def __str__(self):
        return self.rare_words  
    
    class Meta:
        verbose_name = "Редкие слова"
        verbose_name_plural = "Редкие слова"

class CompoundWord(models.Model):
    compound_words = models.TextField(null=True, blank=True,verbose_name='Составные слова')
...
class g1Level(models.Model):
    ...
    g1_lexical_div_q_l1 = models.FloatField(null=True, blank=True,verbose_name='Лексическое разнообразие 1.1')
    g1_lexical_div_q_l2 = models.FloatField(null=True, blank=True,verbose_name='Лексическое разнообразие 1.2')
    g1_lexical_div_q_l3 = models.FloatField(null=True, blank=True,verbose_name='Лексическое разнообразие 1.3')
...
class g2Level(models.Model):
    ...
    g2_lexical_div_q_l1 = models.FloatField(null=True, blank=True,verbose_name='Лексическое разонобразие 2.1')
    g2_lexical_div_q_l2 = models.FloatField(null=True, blank=True,verbose_name='Лексическое разнообразие 2.2')
...
class g3Level(models.Model):
    ...
    g3_lexical_div_q_l1 = models.FloatField(null=True, blank=True,verbose_name='Лексическое разнообразие 3.1')
    g3_lexical_div_q_l2 = models.FloatField(null=True, blank=True,verbose_name='Лексическое разнообразие 3.1')
...
class g4Level(models.Model):
    ...
    g4_lexical_div_q_l1 = models.FloatField(null=True, blank=True,verbose_name='Лексическое разнообразие 4.1')
    g4_lexical_div_q_l2 = models.FloatField(null=True, blank=True,verbose_name='Лексическое разнообразие 4.2')
