...
class HomeView(View):
    def get(self, request, *args, **kwargs):
        ...
        return render(request, 'tj/home.html')
    ...
    def post(self, request, *args, **kwargs):
        ...
        if words_q >3 and detect(message) !='en':
            ...
            for word in all_words:
                ...
                if len(word_without_hyphen) >= 9 and is_polysyllabic(word_without_hyphen, 3):
            ...
            syllables_avg = round((syllables / words_q),2)
            ...
            all_compound_words = compound_w_q + rareword_q + complex_w_q
            ...
            if (words_q <= g1_word_q_l3 and syllables_avg <= g1_avgwl_insyllables_l3 and multisyllabic_wq <= g1_multisyllabic_wq_l3) or (words_q <= g1_word_q_l3 and multisyllabic_wq <= g1_multisyllabic_wq_l3):
                    ...
                    messages.error(request, 'перепроверить')
            ...
            return render(request, 'tj/result.html', context)
