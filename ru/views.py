...
class IndexView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if words_q >3 and detect(message) !='en':
            ...
            fre_oborneva = round((206.835 - (1.3 * sentence_avg) - (60.1 * syllables_avg)),2)

            gunning_fog_index = round((0.4*((0.78*sentence_avg)+100*(multisyllabic_wq/words_q))),1)

            all_compound_words_p = round(((100/words_q) * (multisyllabic_wq + lcwords_q + rareword_q)),1)
            ...
            g1_fre_oborneva_q_l1 = g1Level.objects.values_list('g1_fre_oborneva_q_l1', flat=True). get(id=1)
            g1_fre_oborneva_q_l2 = g1Level.objects.values_list('g1_fre_oborneva_q_l2', flat=True). get(id=1)
            g1_fre_oborneva_q_l3 = g1Level.objects.values_list('g1_fre_oborneva_q_l3', flat=True). get(id=1)
            ...
            g2_fre_oborneva_q_l1 = g2Level.objects.values_list('g2_fre_oborneva_q_l1', flat=True). get(id=1)
            g2_fre_oborneva_q_l2 = g2Level.objects.values_list('g2_fre_oborneva_q_l2', flat=True). get(id=1)
            ...
            g3_fre_oborneva_q_l1 = g3Level.objects.values_list('g3_fre_oborneva_q_l1', flat=True). get(id=1)
            g3_fre_oborneva_q_l2 = g3Level.objects.values_list('g3_fre_oborneva_q_l2', flat=True). get(id=1)
            ...
            g4_fre_oborneva_q_l1 = g4Level.objects.values_list('g4_fre_oborneva_q_l1', flat=True). get(id=1)
            g4_fre_oborneva_q_l2 = g4Level.objects.values_list('g4_fre_oborneva_q_l2', flat=True). get(id=1)
            ...
            context = {'words_q':words_q, 'sentence_q':sentence_q, 'syllables':syllables, 'syllables_avg':syllables_avg, 'sentence_avg':sentence_avg, 'multisyllabic_wq':multisyllabic_wq, 'longw_frequencies':longw_frequencies, 'lword_p':lword_p, 'uniquew_q':uniquew_q,
                        ...
                        'g1_lexical_div_q_l1':g1_lexical_div_q_l1, 'g1_lexical_div_q_l2':g1_lexical_div_q_l2, 'g1_lexical_div_q_l3':g1_lexical_div_q_l3, 'g2_lexical_div_q_l1':g2_lexical_div_q_l1, 'g2_lexical_div_q_l2':g2_lexical_div_q_l2, 'g3_lexical_div_q_l1':g3_lexical_div_q_l1, 'g3_lexical_div_q_l2':g3_lexical_div_q_l2, 'g4_lexical_div_q_l1':g4_lexical_div_q_l1, 'g4_lexical_div_q_l2':g4_lexical_div_q_l2, 'g1_fre_oborneva_q_l1':g1_fre_oborneva_q_l1, 'g1_fre_oborneva_q_l2':g1_fre_oborneva_q_l2, 'g1_fre_oborneva_q_l3':g1_fre_oborneva_q_l3, 'g2_fre_oborneva_q_l1':g2_fre_oborneva_q_l1, 'g2_fre_oborneva_q_l2':g2_fre_oborneva_q_l2, 'g3_fre_oborneva_q_l1':g3_fre_oborneva_q_l1,
                        'g3_fre_oborneva_q_l2':g3_fre_oborneva_q_l2, 'g4_fre_oborneva_q_l1':g4_fre_oborneva_q_l1, 'g4_fre_oborneva_q_l2':g4_fre_oborneva_q_l2, 'all_compound_words_p':all_compound_words_p}
