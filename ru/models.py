...
class g1Level(models.Model):
    ...
    g1_fre_oborneva_q_l1 = models.FloatField(null=True, blank=True,verbose_name='Показатели удобочитаемости 1.1')
    g1_fre_oborneva_q_l2 = models.FloatField(null=True, blank=True,verbose_name='Показатели удобочитаемости 1.2')
    g1_fre_oborneva_q_l3 = models.FloatField(null=True, blank=True,verbose_name='Показатели удобочитаемости 1.3')
...
class g2Level(models.Model):
    ...
    g2_fre_oborneva_q_l1 = models.FloatField(null=True, blank=True,verbose_name='Показатели удобочитаемости 2.1')
    g2_fre_oborneva_q_l2 = models.FloatField(null=True, blank=True,verbose_name='Показатели удобочитаемости 2.2')
...
class g3Level(models.Model):
    ...
    g3_lexical_div_q_l2 = models.FloatField(null=True, blank=True,verbose_name='Лексическое разнообразие 3.2')
    g3_fre_oborneva_q_l1 = models.FloatField(null=True, blank=True,verbose_name='Показатели удобочитаемости 3.1')
    g3_fre_oborneva_q_l2 = models.FloatField(null=True, blank=True,verbose_name='Показатели удобочитаемости 3.2')
...
class g4Level(models.Model):
    ...
    g4_fre_oborneva_q_l1 = models.FloatField(null=True, blank=True,verbose_name='Показатели удобочитаемости 3.1')
    g4_fre_oborneva_q_l2 = models.FloatField(null=True, blank=True,verbose_name='Показатели удобочитаемости 3.2')
